		...
		return (
			<View style={styles.container}>
				<View style={styles.viewContainer}>
					...
					<View
						style={[styles.fieldContainer, this.withBorder(), this.withIcon(), this.withIconButton()]}>
						{this.props.placeholder && (
							<FloatingLabel visible={this.state.text}>
								<Text style={[styles.fieldLabel, this.labelStyle(), this.withIcon(), this.withIconButton()]}>
						...
						<TouchableOpacity style={[styles.touch]} onPress={this.changePwdType}>
							<Image style={[styles.iconContainerButton]}source={this.placeholderIconValueButtom()} />
						</TouchableOpacity>
					</View>
				</View>
			</View>
